...
@section('pageTitle', 'Gallery View')
                ...
                <div class="container ptb-100">
                    <div class="agent-details-wrap">
                        <div class="row gx-5 align-items-center">
                            <div class="col-lg-6">
                                <div class="agent-img">
                                    <img src="{{asset('storage/'. $gallery->file_path)}}" alt="Image">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="agent-info-wrap">
                                    ...
                                    <ul class="agent-info list-style">
                                        <li><b>Experience:</b><span>5 Years</span></li>
                                        <li><b>Address:</b><span>77 Morris St. Ridgewood, NJ 67655 </span></li>
                                        <li><b>Phone:</b><span>+1 719-504-1984 </span></li>
                                        <li><b>Email:</b><span><a
                                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="2a43444c456a58454941464b5f584b04494547">[email&#160;protected]</a></span>
                                        </li>
                                        <li><b>Fax:</b><span>+2 329-504-1984</span></li>
                                    </ul>
                            ...
                            <div class="col-lg-12">
                                <div class="agent-desc">
                                    ...
                                    <p>Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Donec
                                        sollicitudin molestie malesuada. Nulla porttitor accumsan tincidunt. Praesent
                                        sapien massa, convallis a pellentesque nec, egestas non nisi. Curabitur arcu
                                        erat, accumsan id imperdiet et, porttitor at sem. Curabitur non nulla sit amet
                                        nisl tempus convallis quis ac lectus. Proin eget tortor risus. Donec rutrum
                                        congue leo eget malesuada. Pellentesque in ipsum id orci porta dapibus.</p>
                                    <p>Cras ultricies ligula sed magna dictum porta. Nulla quis lorem ut libero
                                        ...
                                        Quisque velit nisi, pretium ut lacinia in, elementum id enim. Vestibulum ante
                                        ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec
                                        velit neque, </p>
                                    <ul class="nav nav-tabs agent-tablist" role="tablist">
                                        <li class="nav-item">
                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab_1"
                                                type="button" role="tab">Listed Properties</button>
                                        </li>
                                        <li class="nav-item">
                                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab_2"
                                                type="button" role="tab">Customer Review</button>
                                        </li>
                                    </ul>
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="property-card style2">
                                                        <div class="property-img-slider owl-carousel">
                                                            ...
                                                            <img src="assets/img/property/property-9.jpg" alt="Image">
                                                            <img src="assets/img/property/property-17.jpg" alt="Image">
                                                        </div>
                                                        <div class="property-info">
                                                            <div class="property-status-wrap">
                                                            ...
                                                            <h3><a href="listing-details.html">Apartment For Rent</a>
                                                            </h3>
                                                            <p><i class="flaticon-location"></i>732 Burwell Road,
                                                                Houston</p>
                                                            <ul class="property-metainfo list-style">
                                                ...
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="property-card style2">
                                                        <div class="property-img-slider owl-carousel">
                                                            ...
                                                            <img src="assets/img/property/property-13.jpg" alt="Image">
                                                            <img src="assets/img/property/property-12.jpg" alt="Image">
                                                        </div>
                                                        <div class="property-info">
                                                            <div class="property-status-wrap">
                                                                <span class="property-status">For Rent</span>
                                                            ...
                                                            <p><i class="flaticon-location"></i>4890 Grey Fox Fam Road,
                                                                Houston</p>
                                                            <ul class="property-metainfo list-style">
                                                                <li><i class="flaticon-double-bed"></i>05</li>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="comment-text">
                                                                        <p>Nulla porttitor accumsan tincidunt. Praesent
                                                                            ...
                                                                            magna dictum porta. Vestibulum ante ipsum
