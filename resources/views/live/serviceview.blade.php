                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6">
                                <div class="property-card style4">
                                    <div class="property-img">
                                        <img src="{{asset('assets2/img/property/property-20.jpg')}}" alt="Image">
                                ...
                                <!-- <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="property-card style4">
                                        <div class="property-img">
                                            <img src="{{asset('assets2/img/property/property-21.jpg')}}" alt="Image">
                                            <span class="property-status">For Rent</span>
                                        </div>
                                        <div class="property-info">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="property-card style4">
                                        <div class="property-img">
                                            <img src="{{asset('assets2/img/property/property-22.jpg')}}" alt="Image">
                                            <span class="property-status">For Rent</span>
                                        </div>
                                        <div class="property-info">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="property-card style4">
                                        <div class="property-img">
                                            <img src="{{asset('assets2/img/property/property-29.jpg')}}" alt="Image">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="property-card style4">
                                        <div class="property-img">
                                            <img src="{{asset('assets2/img/property/property-30.jpg')}}" alt="Image">
                                            <span class="property-status">For Rent</span>
                                        </div>
                                        <div class="property-info">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6">
                                    <div class="property-card style4">
                                        <div class="property-img">
                                            <img src="{{asset('assets2/img/property/property-31.jpg')}}" alt="Image">
                                            <span class="property-status">For Sale</span>
                                        </div>
                                        <div class="property-info">
